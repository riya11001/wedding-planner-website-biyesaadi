...
<section class="step-container">
    ...
    <div class="step">
        ...
        <a href="https://images.app.goo.gl/kLn96U7m8iYMFis17" class="btn">learm more</a>
    </div>
    ...
    <div class="step">
        ...
        <h3>Pre wedding</h3>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum porro iure esse laudantium aspernatur, veniam sunt provident eius cum ab.</p>
        <a href="Pre wedding.php" class="btn">learm more</a>
    </div>
    ...
    <div class="step">
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum porro iure esse laudantium aspernatur, veniam sunt provident eius cum ab.</p>
        <a href="wedding ceremony.php" class="btn">learm more</a>
    </div>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="info">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam, dolores.</p>
                <a href="Invitation card.php" class="btn">learm more</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="info">
                <h3>Food Item</h3>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam, dolores.</p>
                <a href="food item.php" class="btn">learm more</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="info">
                <h3>venu and hall</h3>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam, dolores.</p>
                <a href="vanue.php" class="btn">learm more</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="info">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam, dolores.</p>
                <a href="music.php" class="btn">learm more</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="info">
                <h3>photographer</h3>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam, dolores.</p>
                <a href="photographer.php" class="btn">learm more</a>
            </div>
        </div>
